...
1. #+武器名 原神武器图鉴 支持别名 如`#雾切之回光`、`#雾切`
2. #+圣遗物 原神圣遗物图鉴 支持别名 如`#绝缘之旗印`、`#绝缘`
3. #+原魔名 原魔图鉴一图流（含技能） 支持别名 如`圣骸毒蝎`
4. #+食物名 可查询原神食物图鉴 如`甜甜花酿鸡`、`堆高高`、`来来菜`
5. #+区域特产名 可查询原神区域特产图鉴 如`#清心`、`清心在哪里`等
6. 七圣+牌名 原神七圣召唤图鉴 支持别名 如`七圣交给我吧！`、`七圣交给我吧`
7. 角色名+材料 原神角色材料图鉴 若使用的yunzai内含genshin文件夹，则支持别名 如`神里绫华材料`、`绫华材料`
